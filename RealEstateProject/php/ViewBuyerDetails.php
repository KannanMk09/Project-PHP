...
$query = "Select * from buyer_member;";
...
<head>
    ...
    <link rel="stylesheet" href="../ViewBuyerDetails.css">
    <title>ViewBuyerDetails</title>
</head>
<body>
    ...
    <div class="container">
        <div class="sellorTable">
            <div class="row mt-5">
                <div class="col">
                    <div class="card">
                        <h2 class="display-8 card-header text-center text-white bg-dark p-2">Buyer Property Details</h2>
                    </div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="sellorTable">
            <div class="row mt-5">
                <div class="col">
                    <div class="card">
                        <h2 class="display-8 card-header text-center text-white bg-dark p-2">Buyer Details</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center table-content table-striped table-hover">
                            <tr class="bg-dark text-white">
