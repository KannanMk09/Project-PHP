...
$sql = "Select * from sellorpropertydetails;";
$result =mysqli_query($conn,$sql);

$query = "Select * from sellor_member;";
...
<head>
    ...
    <link rel="stylesheet" href="../ViewSellorDetails.css">
    <title>ViewSellorDetails</title>
</head>
<body>
    ...
    <div class="container">
        <div class="sellorTable">
            <div class="row mt-5">
                <div class="col">
                    <div class="card">
                        <h2 class="display-8 card-header text-center text-white bg-dark p-2">Sellor Property Details</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center table-content table-striped table-hover">
                            ...
                            ?> 
                            <tr class="normal">  
                                <td><?php echo $row['SellorName']; ?></td>
                                <td><?php echo $row['SellorMobile']; ?></td>
                                <td><?php echo $row['SellorPropertyLocation']; ?></td>
                                <td><?php echo $row['SellorPropertyRate']; ?></td>
                                <td><?php echo $row['SellorPropertySqft']; ?></td>
                                <td><?php echo $row['SellorTypeProperty']; ?></td>
                            </tr>   
                            <?php
                                }
                            ?>   
    ...
    <div class="container">
        <div class="sellorTable">
            <div class="row mt-5">
                <div class="col">
                    <div class="card">
                        <h2 class="display-8 card-header text-center text-white bg-dark p-2">Sellor Details</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center table-content table-striped table-hover">
                            <tr class="bg-dark text-white">
