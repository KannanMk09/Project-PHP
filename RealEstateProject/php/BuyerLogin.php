...
<body>
    <div class="d-block mx-auto main-content">
        <h4>Login</h4>
        <form action="./BuyerLoginAction.php" method="post" target="_blank">
                <?php 
            ...
            <span class="signup_Account">Don't have an Account?<a href="./BuyerSignUp.php" class="link_forgot_2">Click Here</a></span>
